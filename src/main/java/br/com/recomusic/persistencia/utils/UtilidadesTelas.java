...
public class UtilidadesTelas {
	...
	/**
	 * Responsável por procurar se a lista de bandas curtidas pelo usuário
	 * existem e se elas já estão cadastradas nas informações de perfil do
	 * usuário
	 */

	/**
	 * @author Guilherme Responsável por procurar se a lista de bandas curtidas
	 *         pelo usuário existem e se elas já estão cadastradas nas
	 *         informações de perfil do usuário
	 * @param listaMusicas
	 *            - lista de BANDAS, existe - se o usuário já existe no sistema
	 * @throws Exception
	...
	/*
	 * Pesquisa na API (através do JSON) todos os gêneros de uma determinada
