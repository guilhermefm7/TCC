...
public class TesteMusica {
	...
	private static void verifyTrack(Track track) throws EchoNestException {
		assertTrue("status check",
				track.getStatus().equals(Track.AnalysisStatus.COMPLETE));
		track.showAll();
	}
	...
	/**
	 * Título da Música Artista/Banda Duração da música em segundos BPM da
	 * música (quantas batidas por minuto) Localização do artista Quanto
	 * dançante a música é Quanto enérgica a música é
	 * 
	 * @param song
